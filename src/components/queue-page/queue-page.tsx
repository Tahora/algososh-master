...
import {smallTimeout} from "../../utils/constats";

export const QueuePage: React.FC = () => {
  const [text, setText] =useState('')
  const dispatch = useAppDispatch();
  const queue=useMemo(()=>{return new Queue(6)},[])
  ...
  async function pushItem()
  {
    ...
    await changeArr(visualState,dispatch,{changingIndx:[tail], tail:tail, head:head},smallTimeout)
